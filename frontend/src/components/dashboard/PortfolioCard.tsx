...
export const PortfolioCard: React.FC<Props> = ({ portfolio, onResetWinRate }) => {
        ...
        <div className="flex items-center justify-between text-xs font-semibold text-slate-400">
          ...
          {onResetWinRate && (
            <button
              ...
              title="Reset Win Rate & Clear Trade History"
              className="rounded px-1.5 py-0.5 text-[10px] font-bold text-slate-400 hover:text-amber-400 bg-dark-700/60 hover:bg-dark-600 border border-dark-500/40 transition-colors"
            >
              Reset
            </button>
          )}
